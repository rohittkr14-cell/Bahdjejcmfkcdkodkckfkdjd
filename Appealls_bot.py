...
# ================= CONFIG =================
BOT_TOKEN = "8360710143:AAE55f0FuU99Mb7hViEIYm-62kr_l5NVKfo"
...
def has_pending_in_group(user_id: int, group_key: str):
    ...
    # ================= START (ONLY IN DM - ALL GROUP MSGS IGNORED) =================
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    # IGNORE everything if sent from a group
...
def main():
    ...
    print("🚀 BOT STARTED - ALL USER COMMANDS IGNORED IN GROUP CHAT")
